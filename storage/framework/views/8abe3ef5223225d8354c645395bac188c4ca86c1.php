													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" width="111" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt;"><img src="https://www.salvafastfood.com/images/logo.png" style="width: 50%" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
														</tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" bgcolor="#ffffff" style="padding: 45px 40px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h2 pb15" style="color:#000000; font-family:'Playfair Display', Georgia, serif; font-size:30px; line-height:46px; text-align:left; font-weight:bold; padding-bottom:15px;"><multiline><?php echo e($name); ?> concern about <?php echo e($enquiry); ?></multiline></td>
														</tr>
														<tr>
															<td class="text pb30" style="color:#999999; font-family:Arial, sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:30px;"><multiline>
                                                                ...
                                                                <strong>Restaurant: </strong> <?php echo e($restaurant); ?> <br>
                                                                <?php endif; ?>
                                                                <?php if(!empty($dine_take_delivery)): ?>
                                                                <strong>Order Type: </strong> <?php echo e($dine_take_delivery); ?> <br>
                                                                <?php endif; ?>
...
</html><?php /**PATH /home/u318926794/domains/salvafastfood.co.uk/public_html/resources/views/contact_email.blade.php ENDPATH**/ ?>