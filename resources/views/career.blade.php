    ...
    <section class="section banner">
        ...
        a part of it.</p>
            ...
            <div class="container career">
                ...
                {{-- <p class="job-info">
          Do you have what it takes to work for one of the fastest-growing
          restaurant brands. The opportunity is here. Salva Fast Kebab is
          changing the perception of the kebab world. Kebabs Done Right.
          With industry-leading levels of service, exceptional food and an
      ...
      <div class="isotope" data-isotope-layout="masonry">
        <div class="row row-condensed row-no-gutter">
          <div class="col-12 col-md-6 col-lg-7 isotope-item">
            <a
              class="gallery-item gallery-item-fullwidth"
              href="#"
              data-toggle="modal"
            ...
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="{{ asset('images/cheff-img1.jpg') }}"
                    alt=""
                    class="img-fluid"
                  />
                </figure>
          ...
          <div class="col-12 col-md-6 col-lg-5 isotope-item">
            ...
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="{{ asset('images/cheff-img2.jpg') }}"
                    alt=""
                    class="img-fluid"
                  />
                </figure>
          ...
          <div class="col-12 col-md-6 col-lg-5 isotope-item">
            ...
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="{{ asset('images/cheff-img3.jpg') }}"
                    alt=""
                    class="img-fluid"
                  />
                </figure>
          ...
          <div class="col-12 col-md-6 col-lg-7 isotope-item">
            <a
              ...
              data-toggle="modal"
              data-target="#jobModal"
              data-job-title="Front of House team member"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="{{ asset('images/cheff-img4.jpg') }}"
                    alt=""
                    class="img-fluid"
                  />
                </figure>
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <div class="input-field-wrap">
                            <input type="text" class="input-field" placeholder="Your Name *" name="fullname"
                              required="" />
                            <div class="focus"></div>
                          </div>
                        ...
                        <div class="col-xs-12">
                          <div class="input-field-wrap">
                            <input type="email" class="input-field" placeholder="Repeat Email *" name="re-email"
                              required="" />
                            <div class="focus"></div>
                          </div>
                          <div class="empty-sm-20 empty-xs-20"></div>
                          ...
                          <div class="radio-boxes">
                            ...
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2"
                                value="option2" />
                              <label class="form-check-label" for="inlineRadio2">No, i'll upload later
                              </label>
                            </div>
                          </div>
                        </div>
                        <div id="cvUploadDiv">
                          ...
                          <div class="f-upload-container d-flex">
                            ...
                            <label for="file-upload">Browse<input type="file" id="file-upload" name="cvFile"
                ...
                <div class="modal-body px-5">
                    <div class="container">
                        <form class="job-form needs-validation" enctype="multipart/form-data" method="POST"
                            id="job-form" action="{{ route('career') }}" novalidate>
                            @csrf
                            {{-- <div>
                <h3>Job Details</h3>
                <div>
