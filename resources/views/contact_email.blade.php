										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" bgcolor="#ffffff" style="padding: 45px 40px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h2 pb15" style="color:#000000; font-family:'Playfair Display', Georgia, serif; font-size:30px; line-height:46px; text-align:left; font-weight:bold; padding-bottom:15px;"><multiline>{{ $name }} concern about {{ $enquiry }}</multiline></td>
														</tr>
														<tr>
															<td class="text pb30" style="color:#999999; font-family:Arial, sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:30px;"><multiline>
                                                                ...
                                                                @if (!empty($restaurant))
                                                                <strong>Restaurant: </strong> {{ $restaurant }} <br>
                                                                @endif
                                                                @if (!empty($dine_take_delivery))
                                                                <strong>Order Type: </strong> {{ $dine_take_delivery }} <br>
                                                                @endif
